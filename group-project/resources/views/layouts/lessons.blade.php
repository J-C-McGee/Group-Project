    ...
    <div class="grid grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-lg">
            ...
            <div class="p-4">
                ...
                <a href="courses2" class= "p-8 text-blue-500 hover:underline"> Start Course</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md">
            ...
            <div class="p-4">
                ...
                <a href="courses3" class= "p-8 text-blue-500 hover:underline"> Start Course</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md">
            ...
            <div class="p-4">
                ...
                <p class="text-gray-700">Learn how to use JQuery to add animations and effects to your web page utilizing a JQuery library. </p>
                <a href="courses4" class= "p-8 text-blue-500 hover:underline"> Start Course</a>
            </div>
        </div>
    </div>
</div>
